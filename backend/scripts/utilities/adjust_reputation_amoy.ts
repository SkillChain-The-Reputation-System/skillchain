...
const deploymentPath = path.resolve(
  __dirname,
  '../../ignition/deployments/chain-80002/deployed_addresses.json'
);
...
const csvPath = path.resolve(
  __dirname,
  '../data/reputation_adjustments_amoy.csv'
);
...
if (allArgs.includes('help') || allArgs.includes('--help') || allArgs.includes('-h')) {
  ...
  console.log("============================");
  console.log("Usage:");
  console.log("  npm run adjust:reputation:amoy              - Process CSV file and adjust reputations");
  console.log("  npm run adjust:reputation:amoy check <addr> - Check current reputation for a user");
  console.log("  npm run adjust:reputation:amoy help         - Show this help message");
  console.log("");
  ...
  if (userAddress) {
    ...
    console.log("Usage: npm run adjust:reputation:amoy check <user_address>");
  }
} else {
  adjustReputations();
}