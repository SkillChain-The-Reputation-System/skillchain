...
function RadioGroupItem({
  ...
  return (
    <RadioGroupPrimitive.Item
      ...
      className={cn(
        "border-input text-primary focus-visible:border-ring focus-visible:ring-ring/50 \
         ...
         dark:bg-input/30 h-6 w-6 shrink-0 rounded-full border shadow-sm \
    ...
    >
      ...
      >
        <CircleIcon className="fill-white absolute top-1/2 left-1/2 h-3 w-3 -translate-x-1/2 -translate-y-1/2" />
      </RadioGroupPrimitive.Indicator>
    </RadioGroupPrimitive.Item>
  )
}
