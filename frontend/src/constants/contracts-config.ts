...
export const ContractConfig_MeetingManager = {
    address: '0xf5059a5D33d5853360D16C683c16e67980206f36', // Change this every time you deploy the contract
    abi: MeetingManagerArtifact.abi,
};

export const ContractConfig_RecruiterDataManager = {
    address: '0x998abeb3E57409262aE5b751f60747921B33613E', // Change this every time you deploy the contract
