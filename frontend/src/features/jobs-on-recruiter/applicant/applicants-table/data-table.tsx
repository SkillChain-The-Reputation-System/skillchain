...
export function ApplicantsTable<TData, TValue>({
  ...
  const [rowSelection, setRowSelection] = React.useState({});  const [searchTerm, setSearchTerm] = React.useState<string>("");
  const [selectedStatuses, setSelectedStatuses] = 
    React.useState<JobApplicationStatus[]>([]);
